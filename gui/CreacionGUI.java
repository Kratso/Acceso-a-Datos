...
public class CreacionGUI<T> extends javax.swing.JFrame {
	...
	public static Utilidades.Validator<Competicion> validarCompeticion = (c, b) -> {
		...
		try {
			competiciones = MainGUI.con.getCompeticiones().stream().filter((
					co) -> {
		...
		return (competiciones.size() == 0 || b) && c.getNombre().matches(
				"([a-zA-Z\\.\\-]+[ ]?)+") && c.getFechaComienzo().before(c
						.getFechaFin());
	};
		...
		if (t instanceof Posicion) {
			...
			guardarB.addActionListener((evt) -> {
				...
				if (validarCompeticion.validate((Competicion) t, false)) {
					...
					MainGUI.notifica(this, "CREACIÓN CORRECTA", null,
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(layout.createSequentialGroup().addGap(24).addGroup(
						...
						.addContainerGap()).addGroup(layout
								...
								.addComponent(salirB).addPreferredGap(
										ComponentPlacement.RELATED, 66,
										Short.MAX_VALUE).addComponent(guardarB)
								.addPreferredGap(ComponentPlacement.UNRELATED)
								.addComponent(descartarB).addGap(76)));
		layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(53).addGroup(
						layout.createParallelGroup(Alignment.BASELINE)
								.addComponent(nombreL).addComponent(nombreTF,
										GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)).addGap(18)
						.addGroup(layout.createParallelGroup(Alignment.BASELINE)
								.addComponent(descL).addComponent(descTF,
										GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						...
						.addPreferredGap(ComponentPlacement.RELATED, 12,
								Short.MAX_VALUE).addGroup(layout
										...
										.addComponent(guardarB).addComponent(
												descartarB).addComponent(
														salirB))
						.addContainerGap()));
	...
	protected void guardar() {
		...
		if (t instanceof Competicion) {
			...
			if (validarCompeticion.validate(compe, false)) {
				...
				MainGUI.notifica(this, "CREACIÓN CORRECTA", null,
						"Se ha creado la competición correctamente",
						JOptionPane.INFORMATION_MESSAGE);
				try {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CreacionGUI.class.getName()).log(
