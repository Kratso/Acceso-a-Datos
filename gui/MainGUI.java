...
public class MainGUI extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jToggleButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					notificaError(null, "Error de base de datos", e,
		...
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(
				Alignment.TRAILING).addGroup(Alignment.LEADING, jPanel5Layout
		...
		btnDescartar.setBounds(404, 113, 124, 25);
	...
	protected void competicionJComboBox3Selected(Competicion selectedItem) {
		if (selectedItem.equals(competicionNoSeleccionable)) {
			...
			DefaultListModel<Partido> model = new DefaultListModel<>();
